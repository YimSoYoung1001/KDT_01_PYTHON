...
#print(f'{msg[0], msg[1], msg[2], msg[3], msg[4], sep=""}')
#근데 f string에서는 sep을 왜 못썼을까??
...
# 2024만 화면에 출력하기 => 슬라이싱으로 출력하기
print(f'msg[15:20] => {msg[15:20]}') #20이 포함안되니까 out of range 에러가 안뜬다
print(f'msg[-5:20] => {msg[-5:20]}') #음수 인덱스와 양수인덱스 섞어서 사용 가능

# 첫번째부터 시작하는 경우 시작인덱스 생략가능
print(f'msg[0:4] => {msg[0:4]}, msg[:5] => {msg[:5]}')
